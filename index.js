				...
				case 'demote':
					...
					break
                                case 'randomhentai':
                                        ...
                                        reply(mess.wait)
                                        anu = await fetchJson(`https://api.vhtear.com/api/hentai?apikey=BotWeA`, {method: 'get'})
		...
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
				...
				case 'tulis':
					...
					teks = body.slice(7)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/api/nulis?text=${teks}&apikey=BotWeA`, {method: 'get'})
					if (anu.error) return reply(anu.error)
